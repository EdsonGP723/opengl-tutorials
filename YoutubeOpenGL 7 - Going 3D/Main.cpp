...
{ //     COORDINATES     /        COLORS      /   TexCoord  //
	...
	//cubo
	-1.0f, -1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		0.5f,0.5,	//24
	-1.0f, 1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//25
	1.0f, 1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//26
	1.0f, -1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//27
	//Cara Arriba
	-1.0f, -1.0f, -1.0f,	0.83f, 0.70f, 0.44f,		.05f,.05f,	//28
	1.0f, -1.0f,-1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//29
	1.0f, 1.0f, -1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//30
	-1.0, 1.0f, -1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//31
	//Cara abajo
	-1.0f, -1.0f, -1.0f,	0.83f, 0.70f, 0.44f,		.05f,.05f,	//32
	-1.0f, -1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//33
	1.0f, -1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//34
	1.0f, -1.0f,-1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//35
	//Cara frontal
	1.0f, -1.0f,-1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//36
	1.0f, -1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//37
	1.0f, 1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//38
	1.0f, 1.0f, -1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//39
	//Cara Derecha
	1.0f, 1.0f, -1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//40
	1.0f, 1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//41
	-1.0f, 1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//42
	-1.0, 1.0f, -1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//43
	//Cara Trasera
	-1.0, 1.0f, -1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//44
	-1.0f, 1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//45
	-1.0f, -1.0f, 1.0f,		0.83f, 0.70f, 0.44f,		.05f,.05f,	//46
	-1.0f, -1.0f, -1.0f,	0.83f, 0.70f, 0.44f,		.05f,.05f,	//47
};
